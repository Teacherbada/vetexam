...
export default function AdminDashboard() {
  ...
  return <main className="min-h-screen bg-slate-50 p-6"><div className="mx-auto max-w-6xl space-y-6">
    <div className="flex flex-wrap items-center justify-between gap-4"><h1 className="text-3xl font-bold">VetExam Admin</h1><nav className="flex flex-wrap gap-4 text-blue-700"><Link href="/admin/questions">題目維護</Link><Link href="/admin/users">會員管理</Link><Link href="/admin/reports">回報管理</Link><Link href="/">首頁</Link></nav></div>
