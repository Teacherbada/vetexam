...
export default function HomeJourney() {
  return <section className={styles.journey} aria-labelledby="home-journey-title" data-home-reveal>
    ...
    <div className={styles.positioning}>
      <div><h3>你不用自己決定今天該讀什麼。</h3><p>VetExam 會根據你的作答紀錄，整理今日任務、弱點與到期複習，讓每一次刷題更有方向。</p><p className={styles.capabilityNote}>這是產品能力說明。登入並累積作答紀錄後，可在學習計畫查看適用的任務與複習；尚未作答或紀錄不足時，先從刷題或初始診斷開始。</p></div>
